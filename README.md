...
```
cd existing_repo
git remote add origin https://code.swecha.org/Arshitha/resume-chatbot.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.swecha.org/Arshitha/resume-chatbot/-/settings/integrations)
